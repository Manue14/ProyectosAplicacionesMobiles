...
public class UserRepository {
    ...
    public void loginUser(LoginFormObject formObject, final BookRepository.ApiCallback<User> callback) {
        apiService.loginUser(formObject).enqueue(new Callback<User>() {
            @Override
            public void onResponse(Call<User> call, Response<User> response) {
                callback.onSuccess(response.body());
            }
            ...
            @Override
            public void onFailure(Call<User> call, Throwable t) {
                Log.e("UserRepository", "Error loging user", t);
                callback.onFailure(t);
            }
        });
    }
